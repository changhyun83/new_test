...
/*  BT_SettingsUI_CHANGE [gu.bosung@lge.com] 2010-05-19*/
...
public class BluetoothPairingDialog extends AlertActivity implements DialogInterface.OnClickListener,
    ...
    protected void onDestroy() {
        super.onDestroy();
	onCancel();//Praveen temp for Settings ANR when pairing dialog is caancelled
    ...
    public void onClick(DialogInterface dialog, int which) {
		...
		/* BT_SettingsUI_CHANGE [gu.bosung@lge.com] 2010-05-19 START*/
		InputMethodManager ok_Input	= (InputMethodManager)getSystemService(Context.INPUT_METHOD_SERVICE);
                if(ok_Input.isActive()){
                	ok_Input.hideSoftInputFromWindow(mPairingView.getWindowToken(), 0);
                }
		/* BT_SettingsUI_CHANGE [gu.bosung@lge.com] 2010-05-19 END*/
                break;

            case DialogInterface.BUTTON_NEGATIVE:
                onCancel();
		/* BT_SettingsUI_CHANGE [gu.bosung@lge.com] 2010-05-19 START*/
		InputMethodManager cancle_Input	= (InputMethodManager)getSystemService(Context.INPUT_METHOD_SERVICE);
                if(cancle_Input.isActive()){
                	cancle_Input.hideSoftInputFromWindow(mPairingView.getWindowToken(), 0);
                }
		/* BT_SettingsUI_CHANGE [gu.bosung@lge.com] 2010-05-19 END*/
                break;
        }
