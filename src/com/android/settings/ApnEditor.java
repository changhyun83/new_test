...
/* LGE_UPDATE_S [Data_Eclair_010][sumi98.kim@lge.com] 2009.12.24 not to edit the default setting */
import android.content.ContentResolver;
import android.preference.PreferenceScreen;
import android.provider.Settings;
/* LGE_UPDATE_E [Data_Eclair_010][sumi98.kim@lge.com] 2009.12.24 not to edit the default setting */
...
// LGE_WCDMA_FEATURE_MERGE  START
/* LGE_UPDATE_S [Data_Eclair_002][sumi98.kim@lge.com] 2009.06.02 Add the interface for some application to activate the particular apn */
//    private EditTextPreference mPreferApp;
/* LGE_UPDATE_E [Data_Eclair_002][sumi98.kim@lge.com] 2009.06.02 Add the interface for some application to activate the particular apn */
// LGE_WCDMA_FEATURE_MERGE  END
...
//    private Integer mDefaultSetting = 0;
    private static String operator_code = "OPEN"; 
    private static String country_code = "FR"; 	
/* LGE_UPDATE_E [Data_Eclair_010][sumi98.kim@lge.com] 2009.12.24 not to edit the default setting */

    interface AuthTypeConstants {
        final int NOT_SET = -1;
        final int NONE = 0;
        final int PAP = 1;
        final int CHAP = 2;
        final int PAP_CHAP = 3;
    }
// LGE_WCDMA_FEATURE_MERGE  END
    /**
...
// LGE_WCDMA_FEATURE_MERGE  START
/* LGE_UPDATE_S [Data_Eclair_002][sumi98.kim@lge.com] 2009.06.02 Add the interface for some application to activate the particular apn */     
//            Telephony.Carriers.PREFERAPP, // 16		
/* LGE_UPDATE_S [Data_Eclair_002][sumi98.kim@lge.com] 2009.06.02 Add the interface for some application to activate the particular apn */
/* LGE_UPDATE_S [Data_Eclair_010][sumi98.kim@lge.com] 2009.12.24 not to edit the default setting */
//           Telephony.Carriers.DEFAULTSETTING, //17
/* LGE_UPDATE_E [Data_Eclair_010][sumi98.kim@lge.com] 2009.12.24 not to edit the default setting */
...
// LGE_WCDMA_FEATURE_MERGE  START
/* LGE_UPDATE_S [Data_Eclair_002][sumi98.kim@lge.com] 2009.06.02 Add the interface for some application to activate the particular apn */
//    private static final int PREFERAPP_INDEX = 16;	
/* LGE_UPDATE_E [Data_Eclair_002][sumi98.kim@lge.com] 2009.06.02 Add the interface for some application to activate the particular apn */
/* LGE_UPDATE_S [Data_Eclair_010][sumi98.kim@lge.com] 2009.12.24 not to edit the default setting */
//    private static final int DEFAULTSETTING_INDEX = 17;
/* LGE_UPDATE_E [Data_Eclair_010][sumi98.kim@lge.com] 2009.12.24 not to edit the default setting */
// LGE_WCDMA_FEATURE_MERGE  END
...
// LGE_WCDMA_FEATURE_MERGE  START
/* LGE_UPDATE_S [Data_Eclair_002][sumi98.kim@lge.com] 2009.06.02 Add the interface for some application to activate the particular apn */
        //mPreferApp = (EditTextPreference) findPreference("apn_preferapp");
/* LGE_UPDATE_E [Data_Eclair_002][sumi98.kim@lge.com] 2009.06.02 Add the interface for some application to activate the particular apn */ 
...
/* LGE_UPDATE_S [Data_Eclair_010][sumi98.kim@lge.com] 2009.12.24 not to edit the default setting
	...
	if(checkProfileEditable() == false){
		Log.v("ApnEditor", "This is the Default Setting.");
...
// LGE_WCDMA_FEATURE_MERGE  START
/* LGE_UPDATE_S [Data_Eclair_002][sumi98.kim@lge.com] 2009.06.02 Add the interface for some application to activate the particular apn */	
            //mPreferApp.setText(mCursor.getString(PREFERAPP_INDEX));
/* LGE_UPDATE_E [Data_Eclair_002][sumi98.kim@lge.com] 2009.06.02 Add the interface for some application to activate the particular apn */
// LGE_WCDMA_FEATURE_MERGE  END
            if (mNewApn) {
                String numeric =
...
// LGE_WCDMA_FEATURE_MERGE  START
            if (authVal >= AuthTypeConstants.NONE && authVal <= AuthTypeConstants.PAP_CHAP) {
                if (authVal == AuthTypeConstants.PAP_CHAP) {
                    authVal = AuthTypeConstants.PAP;
                }
// LGE_WCDMA_FEATURE_MERGE  END
                mAuthType.setValueIndex(authVal);
            }
// LGE_WCDMA_FEATURE_MERGE  START
            else if (authVal == AuthTypeConstants.NOT_SET) {
...
// LGE_WCDMA_FEATURE_MERGE  START
            if (authValIndex == AuthTypeConstants.PAP_CHAP) {
                authValIndex = AuthTypeConstants.PAP;
            }
// LGE_WCDMA_FEATURE_MERGE  END
...
// LGE_WCDMA_FEATURE_MERGE  START
/* LGE_UPDATE_S [Data_Eclair_002][sumi98.kim@lge.com] 2009.06.02 Add the interface for some application to activate the particular apn */	
        //mPreferApp.setSummary(checkNull(mPreferApp.getText()));
/* LGE_UPDATE_E [Data_Eclair_002][sumi98.kim@lge.com] 2009.06.02 Add the interface for some application to activate the particular apn */	
// LGE_WCDMA_FEATURE_MERGE  END
    }
...
// LGE_WCDMA_FEATURE_MERGE  START
/* LGE_UPDATE_S [Data_Eclair_002][sumi98.kim@lge.com] 2009.06.02 Add the interface for some application to activate the particular apn */
//        values.put(Telephony.Carriers.PREFERAPP, "");//checkNotSet(mPreferApp.getText()));
/* LGE_UPDATE_E [Data_Eclair_002][sumi98.kim@lge.com] 2009.06.02 Add the interface for some application to activate the particular apn */
/* LGE_UPDATE_S [Data_Eclair_010][sumi98.kim@lge.com] 2009.12.24 not to edit the default setting */
//    values.put(Telephony.Carriers.DEFAULTSETTING, mDefaultSetting);
/* LGE_UPDATE_E [Data_Eclair_010][sumi98.kim@lge.com] 2009.12.24 not to edit the default setting */
// LGE_WCDMA_FEATURE_MERGE  END
...
// LGE_WCDMA_FEATURE_MERGE  START
/* LGE_UPDATE_S [Data_Eclair_006][sumi98.kim@lge.com] 2009.09.02 written password hidden in display */
/*********************** original code start ***************************
// LGE_WCDMA_FEATURE_MERGE  END
        if (pref != null) {
// LGE_WCDMA_FEATURE_MERGE  START
...
/* LGE_UPDATE_E [Data_Eclair_006][sumi98.kim@lge.com] 2009.09.02 written password hidden in display */	
// LGE_WCDMA_FEATURE_MERGE  END
