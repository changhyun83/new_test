...
/* LGE_UPDATE_S [Data_Eclair_004][sumi98.kim@lge.com] 2009.07.25 Change the APN reading routine from the xml file to flex file */
...
/* LGE_UPDATE_E [Data_Eclair_004][sumi98.kim@lge.com] 2009.07.25 Change the APN reading routine from the xml file to flex file */
...
// LGE_WCDMA_FEATURE_MERGE  START
/* LGE_UPDATE_S [Data_Eclair_004][sumi98.kim@lge.com] 2009.07.25 Change the APN reading routine from the xml file to flex file */
public static void loadOperatorCode()
	{
			// LGE system 
			countrycode = "CA";
			operator_code = "TLS";
...
// LGE_WCDMA_FEATURE_MERGE  START
	...
	Cursor cursor;
	Log.d(TAG, "[ApnSettings] operator_code is : " + operator_code);
	if ("OPEN".equals(operator_code) || "SFR".equals(operator_code))
	{
		Log.d(TAG, "[ApnSettings] where called : " + operator_code);
                cursor = managedQuery(Telephony.Carriers.CONTENT_URI, new String[] {
                "_id", "name", "apn", "type"}, where,
                Telephony.Carriers.DEFAULT_SORT_ORDER);
        }
        else
        {
              Log.d(TAG, "[ApnSettings] null called : " + operator_code);	
              cursor = managedQuery(Telephony.Carriers.CONTENT_URI, new String[] {
              "_id", "name", "apn", "type"}, null,
              Telephony.Carriers.DEFAULT_SORT_ORDER);
        }
/* LGE_UPDATE_E [Data_Eclair_004][sumi98.kim@lge.com] 2009.07.25 Change the APN reading routine from the xml file to flex file */
// LGE_WCDMA_FEATURE_MERGE  END
