...
// LGE_AUTO_IP START
    // key to find AutoIP checkbox on Preferences screen
    private static final String KEY_WIFI_AUTO_IP = "wifi_auto_ip";
// LGE_AUTO_IP END
...
// LGE_WCDMA_FEATURE_MERGE  START
// LGE_AUTO_IP START
    // checkbox to enable.disable AutoIP feature
    private CheckBoxPreference mWifiAutoIp;
// LGE_AUTO_IP END
// LGE_WCDMA_FEATURE_MERGE  END
...
// LGE_WCDMA_FEATURE_MERGE  START
// LGE_AUTO_IP START
        // initialization of AutoIP status
        mWifiAutoIp = (CheckBoxPreference) findPreference(KEY_WIFI_AUTO_IP);
        WifiManager wifiManager = (WifiManager) getSystemService(WIFI_SERVICE);
        boolean enabled = wifiManager.isAutoIpEnabled();
        if (wifiManager.setAutoIpEnabled(enabled)) {
            mWifiAutoIp.setChecked(enabled);
        }
//LGE_AUTO_IP END
// LGE_WCDMA_FEATURE_MERGE  END
...
// LGE_AUTO_IP START
        // set current AutoIP status
            else if (preference == mWifiAutoIp) {
            boolean isChecked = mWifiAutoIp.isChecked();
            WifiManager wifiManager = (WifiManager) getSystemService(WIFI_SERVICE);
            wifiManager.setAutoIpEnabled(isChecked);
        }
// LGE_AUTO_IP END
        else {
// LGE_WCDMA_FEATURE_MERGE  END
