...
//ANDY_PORTING LGIME [hyejeong.yoon@lge.com 100910] LGIME porting
...
public class UserDictionarySettings extends ListActivity {
    ...
    ////ANDY_PORTING LGIME [hyejeong.yoon@lge.com 100910] LGIME porting
    private boolean safeStartLGIMEUserDictionarySettings(){
        String defInputMethodId = Settings.Secure.getString(getContentResolver(), Settings.Secure.DEFAULT_INPUT_METHOD);
        if(defInputMethodId.equals("com.lge.android.aime/.AIME")){
	    	Intent intent = new Intent();
	        intent.setClassName("com.lge.android.aime", "com.lge.android.aime.AIMUserDictionarySettings");
	...
	//ANDY_PORTING LGIME [hyejeong.yoon@lge.com 100910] LGIME porting
        if(safeStartLGIMEUserDictionarySettings()){
	        finish();
            return;
        }
        //ANDY_END
