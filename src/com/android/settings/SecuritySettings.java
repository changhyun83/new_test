...
//[Start][2010.10.27]jinseok.choi@lge.com - Disable Setup SIM Card Lock Menu when SIM State Not Ready
import com.android.internal.telephony.IccCard;
import com.android.internal.telephony.Phone;
import com.android.internal.telephony.PhoneFactory;
//[End][2010.10.27]jinseok.choi@lge.com - Disable Setup SIM Card Lock Menu when SIM State Not Ready
...
//[Start][2010.10.27]jinseok.choi@lge.com - Disable Setup SIM Card Lock Menu when SIM State Not Ready
    // debug data
    private static final String LOG_TAG = "SecuritySettings";
...
//[End][2010.10.27]jinseok.choi@lge.com - Disable Setup SIM Card Lock Menu when SIM State Not Ready
 ...
 //[Start][2010.10.27]jinseok.choi@lge.com -  Disable Setup SIM Card Lock Menu when SIM State Not Ready
	     ...
	     if (DBG) Log.d(LOG_TAG, "IccCard.State : " + state.toString());

	     if(state != IccCard.State.READY)
	     {		  
		  simLockPreferences.setEnabled(false);
		  if (DBG) Log.d(LOG_TAG, "IccCard.State Not Ready : setEnabled - false");
	      }
	      else
	     {
	         simLockPreferences.setEnabled(true);
		  if (DBG) Log.d(LOG_TAG, "IccCard.State Ready : setEnabled - true");
	      }
 //[End][2010.10.27]jinseok.choi@lge.com -  Disable Setup SIM Card Lock Menu when SIM State Not Ready
        }
