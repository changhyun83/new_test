...
//[Start][2010-10-19]jinseok.choi@lge.com, for PUK UnBlock Screen, Remaining Counter, Merge from P970
...
//[Start][2010-10-19]jinseok.choi@lge.com, for PUK UnBlock Screen, Remaining Counter, Merge from P970
// 20100507 euikuk.jeong@lge.com Porting LGE patch <Add retry count text> from Aloha [START_LGE]
    private static final String SAVED_OLD_PIN = "savedOldPin";
    private static final String SAVED_NEW_PIN = "savedNewPin";
// 20100507 euikuk.jeong@lge.com Porting LGE patch <Add retry count text> from Aloha [END_LGE]
//[End][2010-10-19]jinseok.choi@lge.com, for PUK UnBlock Screen, Remaining Counter, Merge from P970
...
//[Start][2010-10-19]jinseok.choi@lge.com, for PUK UnBlock Screen, Remaining Counter, Merge from P970
// 20100507 euikuk.jeong@lge.com Porting LGE patch <Add retry count text> from Aloha [START_LGE]
            mOldPin = savedInstanceState.getString(SAVED_OLD_PIN);
            mNewPin = savedInstanceState.getString(SAVED_NEW_PIN);
// 20100507 euikuk.jeong@lge.com Porting LGE patch <Add retry count text> from Aloha [END_LGE]
//[End][2010-10-19]jinseok.choi@lge.com, for PUK UnBlock Screen, Remaining Counter, Merge from P970
...
// 20100507 euikuk.jeong@lge.com Porting LGE patch <Add retry count text> from Aloha [START_LGE]
        ...
        try {
            attemptsRemaining = ITelephony.Stub.asInterface(ServiceManager.checkService("phone")).getIccPin1RetryCount();
...
//[Start][2010-10-19]jinseok.choi@lge.com, for PUK UnBlock Screen, Remaining Counter, Merge from P970
// 20100507 euikuk.jeong@lge.com Porting LGE patch <Add retry count text> from Aloha [START_LGE]
            out.putString(SAVED_OLD_PIN, mOldPin);
            out.putString(SAVED_NEW_PIN, mNewPin);	
// 20100507 euikuk.jeong@lge.com Porting LGE patch <Add retry count text> from Aloha [END_LGE]
//[End][2010-10-19]jinseok.choi@lge.com, for PUK UnBlock Screen, Remaining Counter, Merge from P970
...
//[Start][2010-10-19]jinseok.choi@lge.com, for PUK UnBlock Screen, Remaining Counter, Merge from P970
// 20100507 euikuk.jeong@lge.com Porting LGE patch <Add retry count text> from Aloha [START_LGE]
        if ((mDialogState == ICC_LOCK_MODE) || (mDialogState == ICC_OLD_MODE))
        {
            int attemptsRemaining = -1;
            try {
                attemptsRemaining = ITelephony.Stub.asInterface(ServiceManager.checkService("phone")).getIccPin1RetryCount();
            ...
            mPinDialog.setDialogMessage(message + "\n" + getText(com.lge.internal.R.string.STR_TITLETEXT_UICC_REMAINING_COMMON_SHORT) + attemptsRemaining);
	     Log.d("IccLockSetting","show pin popup1 remaining :" + attemptsRemaining);
        }
        else
// 20100507 euikuk.jeong@lge.com Porting LGE patch <Add retry count text> from Aloha [END_LGE]
//[End][2010-10-19]jinseok.choi@lge.com, for PUK UnBlock Screen, Remaining Counter, Merge from P970
...
// 20100507 euikuk.jeong@lge.com Porting LGE patch <Add retry count text> from Aloha [START_LGE]
        resetDialogState();
// 20100507 euikuk.jeong@lge.com Porting LGE patch <Add retry count text Matches> from Aloha [END_LGE]
//[End][2010-10-19]jinseok.choi@lge.com, for PUK UnBlock Screen, Remaining Counter, Merge from P970
