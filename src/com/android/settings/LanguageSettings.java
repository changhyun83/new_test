...
// LGE_WCDMA_FEATURE_MERGE  END
	...
	String lastInputMethodId = Settings.Secure.getString(getContentResolver(),Settings.Secure.DEFAULT_INPUT_METHOD);
        if(lastInputMethodId.equals("com.lge.android.aime/.AIME")){
	        addPreferencesFromResource(R.xml.language_settings_lgime);
        }else{
// LGE_WCDMA_FEATURE_MERGE  START
		//gillc@junglesystem.com(091219).begin: added for LG IME User Dictionary
// LGE_WCDMA_FEATURE_MERGE  END
        	addPreferencesFromResource(R.xml.language_settings);
// LGE_WCDMA_FEATURE_MERGE  START
		//gillc@junglesystem.com(091219).end
// LGE_WCDMA_FEATURE_MERGE  END			
        }
	//ANDY_END
