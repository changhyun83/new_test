...
public class QosProfilePickerActivity extends ListActivity {

    static final String TAG = "QosProfilePickerActivity";
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Uri url = ContentUris.withAppendedId(Telephony.QoSProfileColumns.CONTENT_URI, index);
